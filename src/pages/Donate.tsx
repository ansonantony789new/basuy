        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-5 gap-16">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="lg:col-span-3 bg-card p-8 md:p-10 rounded-2xl shadow-card"
            >
              <form onSubmit={handleDonate} className="space-y-8">
                {/* Donation Type */}
                <div>
                  <h3 className="font-display text-xl font-semibold mb-4">Donation Type</h3>
                ...
                {/* Amount Selection */}
                <div>
                  <h3 className="font-display text-xl font-semibold mb-4">Select Amount</h3>
                ...
                {/* Personal Info */}
                <div>
                  <h3 className="font-display text-xl font-semibold mb-4">Your Information</h3>
